    ...
    return (
        <>
            <div className="flex justify-center ">
                <Link to={`/${link}/mappa`}>
                    <div className="  w-70 h-90 m-5 rounded-3xl bg-[#f2ead3] border-4 border-[#0e0d0d8f] shadow-xl transition-transform duration-1000 hover:scale-105 hover:shadow-2xl ">
